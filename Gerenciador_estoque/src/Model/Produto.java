...
public class Produto {
		...
		public Produto(String nome_item, String data_validade, String marca, Integer quantidade, Peso peso_produto, Double valor) {
		...
		public Produto(String nome_item, String marca, Integer quantidade, Peso peso_produto, Double valor) {
			this.nome_item = nome_item;
			this.marca = marca;
			this.quantidade = quantidade;
			this.peso_produto = peso_produto;
